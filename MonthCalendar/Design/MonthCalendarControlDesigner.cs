namespace CustomControls.Design
{
   ...
   internal class MonthCalendarControlDesigner : ControlDesigner
   {
      ...
      internal class MonthCalendarControlDesignerActionList : DesignerActionList
      {
         ...
         /// </summary>
		 private readonly CustomControls.SphMonthCalendar cal;
            ...
            : base(component)
         {
			...
			if (component == null || (compType != typeof(CustomControls.SphMonthCalendar) && compType != typeof(DatePicker)))
            {
            ...
            {
				this.cal = (CustomControls.SphMonthCalendar)component;
            }
